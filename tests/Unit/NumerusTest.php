...
describe('Static Array Operations', function (): void {
    describe('Happy Path', function (): void {
        ...
        test('calculates sum by key', function (): void {
            $items = [
                ['unitValue' => 10],
                ['unitValue' => 20],
                ['unitValue' => 30],
            ...
            $sum = Numerus::sumBy($items, 'unitValue');
            expect($sum->value())->toEqual(60);
        });

        test('calculates sum by callback', function (): void {
            $items = [
                ['unitValue' => 10],
                ['unitValue' => 20],
                ['unitValue' => 30],
            ...
            $sum = Numerus::sumBy($items, static fn (array $item): int => $item['unitValue']);
            expect($sum->value())->toEqual(60);
        });

        test('calculates sum by callback with key', function (): void {
            $items = [
                ['unitValue' => 10],
                ['unitValue' => 20],
                ['unitValue' => 30],
            ...
            $sum = Numerus::sumBy($items, static fn (array $item, int $key): int => $item['unitValue'] + $key);
            expect($sum->value())->toEqual(63);
        });

        test('calculates sum product by keys', function (): void {
            $items = [
            ...
            $sum = Numerus::sumProductBy($items, 'quantity', 'unitValue');
            expect($sum->value())->toEqual(110);
        });

        test('calculates sum product by callbacks', function (): void {
            $items = [
                ['quantity' => 2, 'unitValue' => 10],
                ['quantity' => 3, 'unitValue' => 20],
                ['quantity' => 1, 'unitValue' => 30],
            ...
            $sum = Numerus::sumProductBy(
                $items,
                static fn (array $item): int => $item['quantity'],
                static fn (array $item): int => $item['unitValue'],
            );

            expect($sum->value())->toEqual(110);
        });

        test('calculates sum product by keys with defaults', function (): void {
            $items = [
                ['quantity' => 2, 'unitValue' => 10],
                ['unitValue' => 20],
                ['quantity' => 3],
            ...
            $sum = Numerus::sumProductBy($items, 'quantity', 'unitValue');
            expect($sum->value())->toEqual(40);
        });

        test('calculates average by key', function (): void {
            $items = [
                ['unitValue' => 10],
                ['unitValue' => 20],
                ['unitValue' => 30],
            ...
            $avg = Numerus::averageBy($items, 'unitValue');
            expect($avg->value())->toEqual(20);
        });

        test('calculates weighted average by keys', function (): void {
            $items = [
                ['quantity' => 2, 'unitValue' => 10],
                ['quantity' => 3, 'unitValue' => 20],
                ['quantity' => 1, 'unitValue' => 30],
            ...
            $avg = Numerus::weightedAverageBy($items, 'quantity', 'unitValue');
            expect($avg->value())->toEqual(18.333_333_333_3);
        });

        test('calculates minimum by key', function (): void {
            $items = [
                ['unitValue' => 30],
                ['unitValue' => 10],
                ['unitValue' => 20],
            ...
            $min = Numerus::minBy($items, 'unitValue');
            expect($min->value())->toEqual(10);
        });

        test('calculates maximum by key', function (): void {
            $items = [
                ['unitValue' => 30],
                ['unitValue' => 10],
                ['unitValue' => 20],
            ...
            $max = Numerus::maxBy($items, 'unitValue');
            expect($max->value())->toEqual(30);
        });

        test('calculates variance by key', function (): void {
            $items = [
                ['value' => 2],
                ['value' => 4],
                ['value' => 4],
            ...
            $variance = Numerus::varianceBy($items, 'value');
            expect($variance->value())->toEqual(4);
        });

        test('calculates standard deviation by key', function (): void {
            $items = [
                ['value' => 2],
                ['value' => 4],
                ['value' => 4],
            ...
            $stddev = Numerus::standardDeviationBy($items, 'value');
            expect($stddev->value())->toEqual(2.0);
        });

        test('calculates sample variance by key', function (): void {
            $items = [
                ['value' => 2],
                ['value' => 4],
                ['value' => 4],
            ...
            $variance = Numerus::sampleVarianceBy($items, 'value');
            expect($variance->value())->toEqual(4.571_428_571_4);
        });

        test('calculates sample standard deviation by key', function (): void {
            $items = [
                ['value' => 2],
                ['value' => 4],
                ['value' => 4],
            ...
            $stddev = Numerus::sampleStandardDeviationBy($items, 'value');
            expect($stddev->value())->toBeGreaterThan(2.138_089_935_2);
            expect($stddev->value())->toBeLessThan(2.138_089_935_4);
        });

        test('calculates median by key', function (): void {
            $items = [
                ['value' => 1],
                ['value' => 5],
                ['value' => 3],
            ...
            $median = Numerus::medianBy($items, 'value');
            expect($median->value())->toEqual(3);
        });

        test('calculates median by key for even count', function (): void {
            $items = [
                ['value' => 1],
                ['value' => 5],
                ['value' => 3],
            ...
            $median = Numerus::medianBy($items, 'value');
            expect($median->value())->toEqual(4);
        });

        test('calculates percentile by key', function (): void {
            $items = [
                ['value' => 15],
                ['value' => 20],
                ['value' => 35],
            ...
            $p40 = Numerus::percentileBy($items, 40, 'value');
            expect($p40->value())->toEqual(29);
        });

        test('calculates percentile by key with nearest rank method', function (): void {
            $items = [
                ['value' => 15],
                ['value' => 20],
                ['value' => 35],
            ...
            $p40 = Numerus::percentileBy($items, 40, 'value', method: 'nearest_rank');
            expect($p40->value())->toEqual(20);
        });

        test('calculates ratio by keys', function (): void {
            $items = [
                ['quantity' => 2, 'value' => 10],
                ['quantity' => 3, 'value' => 20],
                ['quantity' => 1, 'value' => 30],
            ...
            $ratio = Numerus::ratioBy($items, 'quantity', 'value');
            expect($ratio->value())->toEqual(0.1);
        });

        test('calculates mode by key', function (): void {
            $items = [
                ['value' => 10],
                ['value' => 20],
                ['value' => 20],
            ...
            $mode = Numerus::modeBy($items, 'value');
            expect($mode->value())->toEqual(30);
        });

        test('counts items by predicate', function (): void {
            $items = [
                ['value' => 10],
                ['value' => 20],
                ['value' => 30],
            ...
            $count = Numerus::countWhere($items, static fn (array $item): bool => $item['value'] >= 30);
            expect($count)->toEqual(2);
        });

        test('counts items by selector values', function (): void {
            $items = [
                ['value' => 10],
                ['value' => 20],
                ['value' => 20],
            ...
            $counts = Numerus::countBy($items, 'value');
        ...
        test('calculates multiple modes by key when tied', function (): void {
            $items = [
                ['value' => 10],
                ['value' => 10],
                ['value' => 20],
            ...
            $modes = Numerus::modesBy($items, 'value');

            expect($modes)->toEqual([10, 20]);
        });

        test('calculates sum of squares by key', function (): void {
            $items = [
                ['value' => 2],
                ['value' => 3],
                ['value' => 4],
            ...
            $sumSquares = Numerus::sumOfSquaresBy($items, 'value');
            expect($sumSquares->value())->toEqual(29);
        });

        test('supports dot path selectors', function (): void {
            $items = [
                ['pricing' => ['unit' => ['value' => 10]]],
                ['pricing' => ['unit' => ['value' => 20]]],
                ['pricing' => ['unit' => ['value' => 30]]],
            ];

            $sum = Numerus::sumBy($items, 'pricing.unit.value');
            expect($sum->value())->toEqual(60);
        });

        test('prefers exact key over dot path traversal', function (): void {
            $items = [
                [
                    'pricing.unit.value' => 99,
                    'pricing' => ['unit' => ['value' => 10]],
                ],
            ];

            $sum = Numerus::sumBy($items, 'pricing.unit.value');
            expect($sum->value())->toEqual(99);
        });
        ...
        test('calculates sum by key for empty array', function (): void {
            $sum = Numerus::sumBy([], 'unitValue');
            expect($sum->value())->toEqual(0);
        });

        test('calculates sum product by keys for empty array', function (): void {
            $sum = Numerus::sumProductBy([], 'quantity', 'unitValue');
            expect($sum->value())->toEqual(0);
        });

        test('calculates minimum by key for single item', function (): void {
            $min = Numerus::minBy([['unitValue' => 42]], 'unitValue');
            expect($min->value())->toEqual(42);
        });

        test('calculates maximum by key for single item', function (): void {
            $max = Numerus::maxBy([['unitValue' => 42]], 'unitValue');
            expect($max->value())->toEqual(42);
        });
    });
    ...
    describe('Sad Path', function (): void {
        ...
        test('throws exception when sum by callback returns non-numeric value', function (): void {
            Numerus::sumBy([['unitValue' => 'x']], static fn (): string => 'invalid');
        })->throws(InvalidArgumentException::class, 'Resolver must return int, float, or Numerus');

        test('throws exception when sum product resolver returns non-numeric value', function (): void {
            Numerus::sumProductBy([['quantity' => 1, 'unitValue' => 2]], static fn (): string => 'invalid', 'unitValue');
        })->throws(InvalidArgumentException::class, 'Resolver must return int, float, or Numerus');

        test('throws exception for average by empty array', function (): void {
            Numerus::averageBy([], 'unitValue');
        })->throws(InvalidArgumentException::class, 'Cannot calculate average of empty array');

        test('throws exception for weighted average by empty array', function (): void {
            Numerus::weightedAverageBy([], 'quantity', 'unitValue');
        })->throws(InvalidArgumentException::class, 'Cannot calculate weighted average of empty array');

        test('throws exception for weighted average by zero total weight', function (): void {
            Numerus::weightedAverageBy([
                ['quantity' => 0, 'unitValue' => 10],
                ['quantity' => 0, 'unitValue' => 20],
            ], 'quantity', 'unitValue');
        })->throws(InvalidArgumentException::class, 'Cannot calculate weighted average with zero total weight');

        test('throws exception for min by empty array', function (): void {
            Numerus::minBy([], 'unitValue');
        })->throws(InvalidArgumentException::class, 'Cannot calculate minimum of empty array');

        test('throws exception for max by empty array', function (): void {
            Numerus::maxBy([], 'unitValue');
        })->throws(InvalidArgumentException::class, 'Cannot calculate maximum of empty array');

        test('throws exception for variance by empty array', function (): void {
            Numerus::varianceBy([], 'value');
        })->throws(InvalidArgumentException::class, 'Cannot calculate variance of empty array');

        test('throws exception for standard deviation by empty array', function (): void {
            Numerus::standardDeviationBy([], 'value');
        })->throws(InvalidArgumentException::class, 'Cannot calculate variance of empty array');

        test('throws exception for sample variance by empty array', function (): void {
            Numerus::sampleVarianceBy([], 'value');
        })->throws(InvalidArgumentException::class, 'Cannot calculate sample variance of empty array');

        test('throws exception for sample variance with fewer than two values', function (): void {
            Numerus::sampleVarianceBy([['value' => 10]], 'value');
        })->throws(InvalidArgumentException::class, 'Cannot calculate sample variance with fewer than two values');

        test('throws exception for sample standard deviation with fewer than two values', function (): void {
            Numerus::sampleStandardDeviationBy([['value' => 10]], 'value');
        })->throws(InvalidArgumentException::class, 'Cannot calculate sample variance with fewer than two values');

        test('throws exception for median by empty array', function (): void {
            Numerus::medianBy([], 'value');
        })->throws(InvalidArgumentException::class, 'Cannot calculate median of empty array');

        test('throws exception for percentile by empty array', function (): void {
            Numerus::percentileBy([], 50, 'value');
        })->throws(InvalidArgumentException::class, 'Cannot calculate percentile of empty array');

        test('throws exception for percentile outside valid range', function (): void {
            Numerus::percentileBy([['value' => 10]], 120, 'value');
        })->throws(InvalidArgumentException::class, 'Percentile must be between 0 and 100');

        test('throws exception for unknown percentile method', function (): void {
            Numerus::percentileBy([['value' => 10]], 50, 'value', method: 'unknown');
        })->throws(InvalidArgumentException::class, 'Unknown percentile method');

        test('throws exception for ratio by zero denominator sum', function (): void {
            Numerus::ratioBy([
                ['quantity' => 2, 'value' => 0],
                ['quantity' => 3, 'value' => 0],
            ], 'quantity', 'value');
        ...
        test('throws exception for mode by empty array', function (): void {
            Numerus::modeBy([], 'value');
        })->throws(InvalidArgumentException::class, 'Cannot calculate mode of empty array');

        test('throws exception for modes by empty array', function (): void {
            Numerus::modesBy([], 'value');
        })->throws(InvalidArgumentException::class, 'Cannot calculate mode of empty array');
    });
