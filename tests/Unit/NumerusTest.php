...
describe('Creation', function (): void {
    describe('Happy Path', function (): void {
        ...
        test('creates instance from string with currency code suffix', function (): void {
            ...
            expect($num->value())->toBe(1_347.55);
        });
    ...
    describe('Edge Cases', function (): void {
        ...
        test('creates instance from very large negative integer', function (): void {
            ...
            expect($num->value())->toBe(\PHP_INT_MIN);
        });
...
describe('Arithmetic Operations', function (): void {
    describe('Happy Path', function (): void {
        test('adds two numbers', function (): void {
            ...
            expect($num->value())->toBe(10); // Original unchanged
        });
    ...
    describe('Edge Cases', function (): void {
        ...
        test('adds very large numbers', function (): void {
            ...
            expect($result->value())->toBe(\PHP_INT_MAX);
        });
...
describe('Rounding Operations', function (): void {
    describe('Happy Path', function (): void {
        ...
        test('rounds with precision', function (): void {
            ...
            expect($result->value())->toBe(42.46);
        });
    ...
    describe('Edge Cases', function (): void {
        ...
        test('rounds with high precision', function (): void {
            ...
            expect($result->value())->toBe(42.123_46);
        });
...
describe('Type Checking', function (): void {
    describe('Happy Path', function (): void {
        ...
        test('returns sign of number', function (): void {
            expect(Numerus::create(42)->sign())->toBe(1);
            expect(Numerus::create(-42)->sign())->toBe(-1);
            expect(Numerus::create(0)->sign())->toBe(0);
            expect(Numerus::create(0.0)->sign())->toBe(0);
        });
    });
    ...
    describe('Edge Cases', function (): void {
        ...
        test('returns sign of very small positive number', function (): void {
            expect(Numerus::create(0.000_000_1)->sign())->toBe(1);
        });
...
describe('Percentage Operations', function (): void {
    describe('Happy Path', function (): void {
        test('calculates percentage of total', function (): void {
            expect(Numerus::create(25)->percentOf(100))->toBe(25.0);
            expect(Numerus::create(50)->percentOf(200))->toBe(25.0);
            expect(Numerus::create(75)->percentOf(150))->toBe(50.0);
        });

        test('adds percentage to value', function (): void {
            expect(Numerus::create(100)->addPercent(20)->value())->toBe(120.0);
            expect(Numerus::create(50)->addPercent(50)->value())->toBe(75.0);
            expect(Numerus::create(100)->addPercent(0)->value())->toBe(100);
        });

        test('subtracts percentage from value', function (): void {
            expect(Numerus::create(100)->subtractPercent(20)->value())->toBe(80.0);
            expect(Numerus::create(50)->subtractPercent(50)->value())->toBe(25.0);
            expect(Numerus::create(100)->subtractPercent(0)->value())->toBe(100);
        });

        test('calculates percentage change', function (): void {
            expect(Numerus::create(50)->percentageChange(75))->toBe(50.0);
            expect(Numerus::create(100)->percentageChange(80))->toBe(-20.0);
            expect(Numerus::create(50)->percentageChange(50))->toBe(0.0);
        });
    });
    ...
    describe('Edge Cases', function (): void {
        test('calculates percentage of same value', function (): void {
            expect(Numerus::create(100)->percentOf(100))->toBe(100.0);
        });

        test('calculates percentage greater than total', function (): void {
            expect(Numerus::create(150)->percentOf(100))->toBe(150.0);
        });

        test('calculates zero percentage of total', function (): void {
            expect(Numerus::create(0)->percentOf(100))->toBe(0.0);
        });

        test('adds 100 percent doubles value', function (): void {
            expect(Numerus::create(50)->addPercent(100)->value())->toBe(100);
        });

        test('subtracts 100 percent results in zero', function (): void {
            expect(Numerus::create(50)->subtractPercent(100)->value())->toBe(0);
        });

        test('calculates percentage change to same value', function (): void {
            expect(Numerus::create(100)->percentageChange(100))->toBe(0.0);
        });

        test('calculates percentage change to zero', function (): void {
            expect(Numerus::create(100)->percentageChange(0))->toBe(-100.0);
        });

        test('calculates percentage change from negative', function (): void {
            expect(Numerus::create(-50)->percentageChange(-25))->toBe(-50.0);
        });
    });
});
...
describe('Mathematical Operations', function (): void {
    describe('Happy Path', function (): void {
        test('calculates greatest common divisor', function (): void {
            expect(Numerus::create(12)->gcd(8)->value())->toBe(4);
            expect(Numerus::create(54)->gcd(24)->value())->toBe(6);
            expect(Numerus::create(17)->gcd(19)->value())->toBe(1);
            expect(Numerus::create(100)->gcd(50)->value())->toBe(50);
        });
        ...
        test('calculates least common multiple', function (): void {
            expect(Numerus::create(4)->lcm(6)->value())->toBe(12);
            expect(Numerus::create(12)->lcm(8)->value())->toBe(24);
            expect(Numerus::create(5)->lcm(7)->value())->toBe(35);
        });

        test('calculates factorial', function (): void {
            expect(Numerus::create(0)->factorial()->value())->toBe(1);
            expect(Numerus::create(1)->factorial()->value())->toBe(1);
            expect(Numerus::create(5)->factorial()->value())->toBe(120);
            expect(Numerus::create(6)->factorial()->value())->toBe(720);
        });
    });
    ...
    describe('Edge Cases', function (): void {
        test('calculates gcd with same numbers', function (): void {
            expect(Numerus::create(12)->gcd(12)->value())->toBe(12);
        });

        test('calculates gcd with one', function (): void {
            expect(Numerus::create(12)->gcd(1)->value())->toBe(1);
        });
        ...
        test('calculates lcm with same numbers', function (): void {
            expect(Numerus::create(12)->lcm(12)->value())->toBe(12);
        });

        test('calculates lcm with one', function (): void {
            expect(Numerus::create(12)->lcm(1)->value())->toBe(12);
        });

        test('calculates lcm with coprime numbers', function (): void {
            expect(Numerus::create(7)->lcm(13)->value())->toBe(91);
        });

        test('calculates factorial of two', function (): void {
            expect(Numerus::create(2)->factorial()->value())->toBe(2);
        });

        test('calculates factorial of three', function (): void {
            expect(Numerus::create(3)->factorial()->value())->toBe(6);
        });

        test('calculates factorial of four', function (): void {
            expect(Numerus::create(4)->factorial()->value())->toBe(24);
        });
    });
});
...
describe('Number Parts', function (): void {
    describe('Happy Path', function (): void {
        test('extracts integer part from positive float', function (): void {
            expect(Numerus::create(12.34)->integerPart())->toBe(12);
        });
        ...
        test('extracts integer part from integer', function (): void {
            expect(Numerus::create(42)->integerPart())->toBe(42);
        });

        test('extracts fractional part from integer', function (): void {
            expect(Numerus::create(42)->fractionalPart())->toBe(0.0);
        });
    });

    describe('Edge Cases', function (): void {
        test('extracts parts from zero', function (): void {
            expect(Numerus::create(0)->integerPart())->toBe(0);
            expect(Numerus::create(0)->fractionalPart())->toBe(0.0);
        });

        test('extracts parts from small positive decimal', function (): void {
            expect(Numerus::create(0.34)->integerPart())->toBe(0);
            expect(Numerus::create(0.34)->fractionalPart())->toBe(0.34);
        });
        ...
        test('extracts parts from very large number', function (): void {
            ...
            expect($num->integerPart())->toBe(9_999_999);
        ...
        test('extracts parts from very small fractional part', function (): void {
            ...
            expect($num->integerPart())->toBe(42);
...
describe('Adapter Integration', function (): void {
    test('works with BCMath adapter returning strings', function (): void {
        ...
        $num = Numerus::create(10.5);
        $result = $num->plus(5.5);

        expect($result->value())->toBe(16.0);

        Math::swap(
            new NativeMathAdapter(),
        );
    });
});
