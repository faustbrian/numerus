...
final readonly class Numerus implements Stringable
{
    ...
    public static function average(array $values): self
    {
        ...
        $sum = array_reduce(
            $values,
            fn ($carry, $val): float|int => $carry + ($val instanceof self ? $val->value : $val),
            0,
        );
    ...
    {
        return new self(round($this->value, $precision, RoundingMode::AwayFromZero));
    }
    ...
    {
        return new self(round($this->value, $precision, RoundingMode::TowardsZero));
    }
    ...
    {
        return new self(round($this->value, $precision, RoundingMode::PositiveInfinity));
    }
    ...
    {
        return new self(round($this->value, $precision, RoundingMode::NegativeInfinity));
    }
    ...
    {
        return new self(round($this->value, $precision, RoundingMode::HalfAwayFromZero));
    }
    ...
    {
        return new self(round($this->value, $precision, RoundingMode::HalfTowardsZero));
    }
    ...
    {
        return new self(round($this->value, $precision, RoundingMode::HalfEven));
    }
    ...
    {
        return new self(round($this->value, $precision, RoundingMode::HalfOdd));
    }
    ...
    public function min(int|float|self $other): self
    {
        ...
        return new self(min($this->value, $value));
    }
    ...
    public function max(int|float|self $other): self
    {
        ...
        return new self(max($this->value, $value));
    }
