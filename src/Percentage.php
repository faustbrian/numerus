...
final class Percentage
{
     ...
     *
     * @throws InvalidArgumentException When total is zero (division by zero)
     *
     ...
     *
     * @throws InvalidArgumentException When original value is zero (division by zero)
     *
     ...
     *
     * @throws InvalidArgumentException When the first value is zero (division by zero)
     *
